...
// GetSystemInfoRequest 表示获取系统信息请求.
...
// GetSystemInfoResponse 表示获取系统信息响应.
...
func (x *GetSystemInfoResponse) GetTotalUsedMb() int64 {
	if x != nil {
...
func (x *GetSystemInfoResponse) GetTotalMb() int64 {
	if x != nil {
		return x.TotalMb
	}
	return 0
...
func (x *GetSystemInfoResponse) GetAvailableMb() int64 {
	if x != nil {
...
func (x *GetSystemInfoResponse) GetErrorCode() string {
	if x != nil {
		return x.ErrorCode
	}
	return ""
...
func (x *GetSystemInfoResponse) GetErrorMsg() string {
	if x != nil {
		return x.ErrorMsg
	}
	return ""
...
var file_proto_interface_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0x16, 0x0a, 0x14, 0x47, 0x65, 0x74, 0x53, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x49,
	0x6e, 0x66, 0x6f, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0xc9, 0x01, 0x0a, 0x15, 0x47,
	0x65, 0x74, 0x53, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x20, 0x0a, 0x0b, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x55, 0x73, 0x65,
	...
	0x72, 0x6f, 0x72, 0x4d, 0x73, 0x67, 0x32, 0x89, 0x01, 0x0a, 0x12, 0x44, 0x61, 0x74, 0x61, 0x4d,
	0x61, 0x6e, 0x61, 0x67, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x73, 0x0a,
	0x0d, 0x47, 0x65, 0x74, 0x53, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x21,
	...
	0x66, 0x6f, 0x42, 0x18, 0x5a, 0x16, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d,
	0x2f, 0x72, 0x65, 0x73, 0x2d, 0x62, 0x61, 0x63, 0x6b, 0x65, 0x6e, 0x64, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_proto_interface_proto_goTypes = []interface{}{
	(*GetSystemInfoRequest)(nil),  // 0: reservation.GetSystemInfoRequest
	(*GetSystemInfoResponse)(nil), // 1: reservation.GetSystemInfoResponse
}
var file_proto_interface_proto_depIdxs = []int32{
	0, // 0: reservation.DataManagerService.GetSystemInfo:input_type -> reservation.GetSystemInfoRequest
	1, // 1: reservation.DataManagerService.GetSystemInfo:output_type -> reservation.GetSystemInfoResponse
