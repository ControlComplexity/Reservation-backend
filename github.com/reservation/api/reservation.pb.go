...
const (
	...
	//高考统招本科
	Education_UNIFIED_BACHELOR Education = 1
	//非全日制本科
	Education_PART_TIME_BACHELOR Education = 2
	//专升本本科
	Education_TRANSFORMED_BACHELOR Education = 3
	//全日制硕士
	Education_FULL_TIME_MASTER Education = 4
	//非全日制硕士
	Education_PART_TIME_MASTER Education = 5
	//全日制博士
	Education_FULL_TIME_DOCTOR Education = 6
	//非全日制博士
	Education_PART_TIME_DOCTOR Education = 7
	//其他
	Education_OTHER Education = 8
)
...
var (
	Education_name = map[int32]string{
		0: "EDUCATION_NONE",
		1: "UNIFIED_BACHELOR",
		2: "PART_TIME_BACHELOR",
		3: "TRANSFORMED_BACHELOR",
		4: "FULL_TIME_MASTER",
		5: "PART_TIME_MASTER",
		6: "FULL_TIME_DOCTOR",
		7: "PART_TIME_DOCTOR",
	...
	Education_value = map[string]int32{
		"EDUCATION_NONE":       0,
		"UNIFIED_BACHELOR":     1,
		"PART_TIME_BACHELOR":   2,
		"TRANSFORMED_BACHELOR": 3,
		"FULL_TIME_MASTER":     4,
		"PART_TIME_MASTER":     5,
		"FULL_TIME_DOCTOR":     6,
		"PART_TIME_DOCTOR":     7,
...
const (
	//默认
	EmotionalStatus_EMOTIONAL_STATUS_NONE EmotionalStatus = 0
	//单身且无婚史
	EmotionalStatus_SINGLE_WITHOUT_MARRIAGE_HISTORY EmotionalStatus = 1
	//单身且离异
	EmotionalStatus_SINGLE_AND_DIVORCED EmotionalStatus = 2
)

// Enum value maps for EmotionalStatus.
var (
	EmotionalStatus_name = map[int32]string{
		0: "EMOTIONAL_STATUS_NONE",
		1: "SINGLE_WITHOUT_MARRIAGE_HISTORY",
		2: "SINGLE_AND_DIVORCED",
	}
	EmotionalStatus_value = map[string]int32{
		"EMOTIONAL_STATUS_NONE":           0,
		"SINGLE_WITHOUT_MARRIAGE_HISTORY": 1,
		"SINGLE_AND_DIVORCED":             2,
	}
)
...
func (x *EditUserReq) GetEmotionalStatus() EmotionalStatus {
	...
	return EmotionalStatus_EMOTIONAL_STATUS_NONE
}
...
type User struct {
	...
	//微信号
	WechatNumber string `protobuf:"bytes,15,opt,name=wechatNumber,proto3" json:"wechatNumber,omitempty"`
	//手机号
...
var file_proto_reservation_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x61, 0x6c, 0x22, 0xa1, 0x04, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x0e, 0x0a,
	...
	0x69, 0x76, 0x65, 0x72, 0x73, 0x69, 0x74, 0x79, 0x12, 0x1e, 0x0a, 0x0a, 0x6f, 0x63, 0x63, 0x75,
	0x70, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x6f, 0x63,
	0x63, 0x75, 0x70, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x18, 0x0a, 0x07, 0x63, 0x6f, 0x6d, 0x70,
	...
	0x65, 0x72, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x77, 0x65, 0x63, 0x68, 0x61, 0x74,
	...
	,
	...
	0x10, 0x01, 0x12, 0x17, 0x0a, 0x13, 0x53, 0x49, 0x4e, 0x47, 0x4c, 0x45, 0x5f, 0x41, 0x4e, 0x44,
	0x5f, 0x44, 0x49, 0x56, 0x4f, 0x52, 0x43, 0x45, 0x44, 0x10, 0x02, 0x2a, 0x1e, 0x0a, 0x06, 0x47,
	0x65, 0x6e, 0x64, 0x65, 0x72, 0x12, 0x08, 0x0a, 0x04, 0x4d, 0x41, 0x4c, 0x45, 0x10, 0x00, 0x12,
	0x0a, 0x0a, 0x06, 0x46, 0x45, 0x4d, 0x41, 0x4c, 0x45, 0x10, 0x01, 0x32, 0xfb, 0x0b, 0x0a, 0x12,
	...
	0x72, 0x2f, 0x65, 0x64, 0x69, 0x74, 0x3a, 0x01, 0x2a, 0x12, 0x66, 0x0a, 0x0d, 0x51, 0x75, 0x65,
	...
	,
